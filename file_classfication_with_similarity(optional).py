...
genai.configure(api_key="AIzaSyBpZd1ohFfsacu-18tDO20RvaX6C9nYRLw") # Thay thế bằng API key của bạn
...
def get_embedding(text, model_name="models/embedding-001"): # Thêm "models/" vào trước tên mô hình
    """
    Gọi API Gemini Embedding cho một đoạn text.
    """
    try:
        ...
        return None # Hoặc xử lý lỗi khác tùy theo nhu cầu của bạn
